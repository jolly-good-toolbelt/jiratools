...
-----------------
    ...
    * ``build-docs.py`` - build the documentation. Open ``docs/index.html`` to read the local docs.
    * ``build-and-push-docs.py`` - build the documentation then push to github pages for this repo.
